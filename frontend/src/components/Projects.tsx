                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.technologies.map((tech, index) => (
                      <span
                        key={tech}
                        className="bg-coral text-white px-3 py-1 rounded-full text-xs font-semibold bounce-hover"
                  ...
                  <div className="flex gap-3 justify-center">
                    {project.githubUrl && (
                      <a
                        ...
                        className="flex items-center gap-1 bg-coral text-white px-4 py-2 rounded-full hover:bg-coral-light transition-colors text-sm font-semibold bounce-hover"
                      >
                    ...
                    {project.liveUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-1 bg-mint text-white px-4 py-2 rounded-full hover:bg-mint-light transition-colors text-sm font-semibold bounce-hover"
                      >
